...
class FlagQuestion extends React.Component{
  static defaultProps = {
    options: [],
  }//This defines default props for the component
  constructor(props){
    super(props);
    this.state = {
      userChoice: undefined,//What does the user choose
    }
  ...
  render(){
    ...
    let output = questionState === QuestionStates.QUESTION ? (<FlagChoices
    handleChange={this.handleChange} handleSubmit={this.handleSubmit} options={opts}/>) :
